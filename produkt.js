...
fetch(`https://dummyjson.com/recipes/${myProductId}`)
  ...
  .then((element) => {
    ...
    <div class="info">
        <div>
            <p>Prep time minutes: ${element.prepTimeMinutes} <span><img class="ikon" src="ikoner/ur.svg" alt="ur"></span></p>

        </div>

        <div>
            <p>Servings: ${element.servings} <span><img class="ikon" src="ikoner/peroner.svg" alt="personer"></span></p>

        </div>

        <div>
            <p>Cook time minutes: ${element.cookTimeMinutes} <span><img class="ikon" src="ikoner/ur.svg" alt="ur"></span></p>
